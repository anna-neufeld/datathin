...
We quickly note that an error will be thrown if `arg` is not a scalar and its dimensions do not match those of the data. This is why we needed to construct the matrix ``good_args`` above. 
