...
vignette: >
  %\VignetteIndexEntry{"Tutorial: introduction"}
...
In this tutorial, we show how to split random variables from all different families.

Question from Anna- how redundant is this. 
